...
const LeafIcon = L.Icon.extend({
   ...
   function onMapClick(e) {
           var mylat = document.getElementById("somefieldlat");
           var mylon = document.getElementById("somefieldlon");
	   if (document.getElementById("somefieldlat") && document.getElementById("somefieldlon")){
	       popup
	           .setLatLng(e.latlng)
